...
![Server graph](https://docs.isaacsim.omniverse.nvidia.com/latest/_images/tutorial_ros2_server_1.PNG)
...
![Server + client](https://docs.isaacsim.omniverse.nvidia.com/latest/_images/tutorial_ros2_server_client_1.PNG)
