...
!!! warning
    The official cuRobo/cuMotion tutorial is no longer maintained — the [cuMotion Integration](https://docs.isaacsim.omniverse.nvidia.com/latest/cumotion/index.html) (`isaacsim.robot_motion.cumotion`) contains much of the same functionality. The cuRobo tutorial is not supported on aarch64.
